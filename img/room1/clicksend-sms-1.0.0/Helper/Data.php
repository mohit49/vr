...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
     * Logging instance
     * @var \Clicksend\Sms\Logger\Logger
     */
    public $logger;
    ...
    public function __construct(
        ...
        \Clicksend\Sms\Logger\Logger $logger
    ) {
        $this->logger = $logger;
    ...
    public function getNewOrderMessage($order)
    {
        ...
        $values =  [ $this->getIncrementId($order), strip_tags($this->priceHelper->currency($order->getGrandTotal())), $order->getStatus(), $order->getShippingDescription(), $order->getPayment()->getMethodInstance()->getTitle(), $order->getCustomerFirstname().' '.$order->getCustomerLastname(), $order->getCustomerEmail() ];
